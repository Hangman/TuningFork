...
/**
 * This provider keeps a list of {@link PlayList}s and iterates through them in order. After a complete run, it starts
 * again with the first PlayList in the list.
 *
 * @author Matthias
 */
