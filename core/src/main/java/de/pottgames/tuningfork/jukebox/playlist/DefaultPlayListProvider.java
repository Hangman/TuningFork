...
/**
 * This provider holds a list of {@link PlayList}s and offers them in order. When a {@link PlayList} is retrieved, it is
 * removed from the list. After all {@link PlayList}s have been retrieved, the provider is empty and no longer supplies
 * new {@link PlayList}s.
 *
 * @author Matthias
 */
