...
/**
 * This provider offers {@link PlayList}s based on the currently set theme. {@link PlayList}s are not consumed/removed
 * when fetched.<br> Theme - PlayList is a 1:1 relation, you can only connect one PlayList to one theme.
 *
 * @author Matthias
 */
public class ThemePlayListProvider implements PlayListProvider {
    ...
    /**
     * Adds a theme and the corresponding {@link PlayList}, potentially replacing a previously set {@link PlayList} for
     * that theme.
     *
