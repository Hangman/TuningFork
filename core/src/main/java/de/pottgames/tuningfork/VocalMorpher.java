...
/**
 * The vocal morpher consists of a pair of 4-band formant filters, used to impose vocal tract effects upon the input
 * signal. If the input signal is a broadband
 * sound such as pink noise or a car engine, the vocal morpher can provide a wide variety of filtering effects. A
 * low-frequency oscillator can be used to morph
 * the filtering effect between two different phonemes. The vocal morpher is not necessarily intended for use on
 * voice signals; it is primarily intended for
...
public class VocalMorpher extends SoundEffectData {
     ...
     * If both parameters are set to the same phoneme, that determines the filtering effect that will be heard. If
     * these two parameters are set to different
     ...
     * This controls the shape of the low-frequency oscillator used to morph between the two phoneme filters. By
     * selecting a saw tooth wave and a slow
     * AL_VOCAL_MORPHER_RATE, one can create a filtering effect that slowly increases or decreases in pitch
     * (depending on which of the two phoneme filters A or
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.phonemea, this.phonemeaCoarseTuning, this.phonemeb, this.phonemebCoarseTuning,
                            this.rate, this.waveform);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.phonemea == other.phonemea && this.phonemeaCoarseTuning == other.phonemeaCoarseTuning &&
               this.phonemeb == other.phonemeb && this.phonemebCoarseTuning == other.phonemebCoarseTuning &&
    ...
    public String toString() {
        return "VocalMorpher [phonemea=" + this.phonemea + ", phonemeb=" + this.phonemeb + ", phonemeaCoarseTuning=" +
               this.phonemeaCoarseTuning + ", phonemebCoarseTuning=" + this.phonemebCoarseTuning + ", waveform=" +
               this.waveform + ", rate=" + this.rate + "]";
    }
