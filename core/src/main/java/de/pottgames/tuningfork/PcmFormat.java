...
public enum PcmFormat {
    SURROUND_7DOT1_16_BIT(EXTMCFormats.AL_FORMAT_71CHN16, 8),
    SURROUND_7DOT1_8_BIT(EXTMCFormats.AL_FORMAT_71CHN8, 8),
    SURROUND_6DOT1_16_BIT(EXTMCFormats.AL_FORMAT_61CHN16, 7),
    SURROUND_6DOT1_8_BIT(EXTMCFormats.AL_FORMAT_61CHN8, 7),
    SURROUND_5DOT1_16_BIT(EXTMCFormats.AL_FORMAT_51CHN16, 6),
    SURROUND_5DOT1_8_BIT(EXTMCFormats.AL_FORMAT_51CHN8, 6),
    QUAD_16_BIT(EXTMCFormats.AL_FORMAT_QUAD16, 4),
    QUAD_8_BIT(EXTMCFormats.AL_FORMAT_QUAD8, 4),
    FLOAT_STEREO_64_BIT(EXTDouble.AL_FORMAT_STEREO_DOUBLE_EXT, 2),
    FLOAT_STEREO_32_BIT(EXTFloat32.AL_FORMAT_STEREO_FLOAT32, 2),
    STEREO_16_BIT(AL10.AL_FORMAT_STEREO16, 2),
    STEREO_8_BIT(AL10.AL_FORMAT_STEREO8, 2),
    FLOAT_MONO_64_BIT(EXTDouble.AL_FORMAT_MONO_DOUBLE_EXT, 1),
    FLOAT_MONO_32_BIT(EXTFloat32.AL_FORMAT_MONO_FLOAT32, 1),
    MONO_16_BIT(AL10.AL_FORMAT_MONO16, 1),
    MONO_8_BIT(AL10.AL_FORMAT_MONO8, 1),
    MS_ADPCM_MONO(SOFTMSADPCM.AL_FORMAT_MONO_MSADPCM_SOFT, 1),
    MS_ADPCM_STEREO(SOFTMSADPCM.AL_FORMAT_STEREO_MSADPCM_SOFT, 2);
    ...
    PcmFormat(int alId, int channels) {
        this.alId = alId;
