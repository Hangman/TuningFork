...
public class SoundBufferLoader extends AsynchronousAssetLoader<SoundBuffer, SoundBufferLoaderParameter> {
    ...
    public Array<AssetDescriptor> getDependencies(
            String fileName, FileHandle file, SoundBufferLoaderParameter parameter) {
    ...
    public void loadAsync(
            AssetManager manager, String fileName, FileHandle file, SoundBufferLoaderParameter parameter) {
