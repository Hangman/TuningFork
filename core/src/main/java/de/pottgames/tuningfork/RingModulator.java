...
public class RingModulator extends SoundEffectData {
     ...
     * result is a tremolo (slow amplitude
     * variation) effect. If the carrier signal is in the audio range, audible upper and lower sidebands begin to
     * appear, causing an inharmonic effect. The
     ...
     * . If the cutoff frequency is 0, the entire
     * signal will be ring modulated. If the cutoff 114/144 frequency is high, very little of the signal (only those
     * parts above the cutoff) will be ring
     * modulated.
     */
     ...
     * generally use a sinusoidal carrier. Sawtooth
    ...
    public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(this.frequency) == Float.floatToIntBits(other.frequency) &&
               Float.floatToIntBits(this.highpassCutoff) == Float.floatToIntBits(other.highpassCutoff) &&
    ...
    public String toString() {
        return "RingModulator [frequency=" + this.frequency + ", highpassCutoff=" + this.highpassCutoff +
