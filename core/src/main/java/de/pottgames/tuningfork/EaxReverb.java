 ...
 * Additional parameters allow for:  Closer
 * control over the tone of the reverb  Reverb directivity, using panning vectors  Reverb granularity, using echo
 * controls The EAX Reverb is natively
 * supported on any devices that support the EAX 3.0 or above standard, including:  SoundBlaster Audigy series
 * soundcards  SoundBlaster X-Fi series soundcards
 * The EAX Reverb will be emulated on devices that only support EAX 2.0. Note: The “Generic Software” device falls
 * into this category as the software mixer
...
public class EaxReverb extends SoundEffectData {
     ...
     * <br>
     * It’s set by default to 1.0, which provides the highest density. Reducing diffusion gives the reverberation a
     * more “grainy” character that is especially
     * noticeable with percussive sound sources. If you set a diffusion value of 0.0, the later reverberation sounds
     ...
     * reverberation) that the reverb effect adds to
     * all sound sources.<br>
     * <br>
     * It sets the maximum amount of reflections and reverberation added to the final sound mix. The value of the
     * Reverb Gain property ranges from 1.0 (0db)
     ...
     * <br>
     * It controls a low-pass filter that applies globally to the reflected sound of all sound sources feeding the
     * particular instance of the reverb effect. The
     * value of the Reverb Gain HF property ranges from 1.0 (0 dB) (no filter) to 0.0 (-100 dB) (virtually no
     * reflected sound). The field highFrequencyReference
     ...
     * The value of the Reverb Gain LF property ranges from 1.0 (0db) (no filter) to 0.0 (-100db) (virtually no
     * reflected sound). The field
     ...
     * <br>
     * It ranges from 0.1 (typically a small room with very dead surfaces) to 20.0 (typically a large room with very
     * live surfaces).
     */
     ...
     * <br>
     * It is the ratio of high-frequency decay time relative to the time set by Decay Time. The Decay HF Ratio value
     * 1.0 is neutral: the decay time is equal for
     * all frequencies. As Decay HF Ratio increases above 1.0, the high-frequency decay time increases so it’s longer
     * than the decay time at low frequencies.
     * You hear a more brilliant reverberation with a longer decay at high frequencies. As the Decay HF Ratio value
     * decreases below 1.0, the high-frequency
     * decay time decreases so it’s shorter than the decay time of the low frequencies. You hear a more natural
     * reverberation.
     */
     ...
     * <br>
     * It is the ratio of low-frequency decay time relative to the time set by Decay Time. The Decay LF Ratio value 1
     * .0 is neutral: the decay time is equal for
     * all frequencies. As Decay LF Ratio increases above 1.0, the low-frequency decay time increases so it’s longer
     * than the decay time at mid frequencies. You
     * hear a more booming reverberation with a longer decay at low frequencies. As the Decay LF Ratio value
     * decreases below 1.0, the low-frequency decay time
     ...
     * .<br>
     * <br>
     * (The Gain property sets the overall amount of reflected sound: both initial reflections and later
     * reverberation.) The value of Reflections Gain ranges
     * from a maximum of 3.16 (+10 dB) to a minimum of 0.0 (-100 dB) (no initial reflections at all), and is
     * corrected by the value of the Gain property. The
     ...
     * effective if you associate the initial
     * reflections increase with a reduction in reflections delays by lowering the value of the Reflection Delay
     * property. To simulate open or semi-open
     * environments, you can maintain the amount of early reflections while reducing the value of the Late Reverb
     * Gain property, which controls later
     * reflections.
     */
     ...
     * The Reflections Delay property is the amount of delay, in seconds, between the arrival time of the direct path
     * from the source to the first reflection
     * from the source.<br>
     * <br>
     * It ranges from 0 to 300 milliseconds. You can reduce or increase Reflections Delay to simulate closer or more
     * distant reflective surfaces and therefore
     ...
     * how focused the reflections are towards this
     * direction.<br>
     * <br>
     * It is important to note that the direction of the vector is interpreted in the coordinate system of the user,
     * without taking into account the orientation
     * of the virtual listener. For instance, assuming a four-point loudspeaker playback system, setting Reflections
     * Pan to (0., 0., 0.7) means that the
     * reflections are panned to the front speaker pair, whereas as setting of (0., 0., −0.7) pans the reflections
     * towards the rear speakers. These vectors
     ...
     * directions. As the magnitude increases, the
     * reflections become more focused in the direction pointed to by the vector. A magnitude of 1.0 would represent
     * the extreme case, where all reflections
     ...
     * .<br>
     * <br>
     * (The Gain property sets the overall amount of both initial reflections and later reverberation.) The value of
     * Late Reverb Gain ranges from a maximum of
     * 10.0 (+20 dB) to a minimum of 0.0 (-100 dB) (no late reverberation at all). Note that Late Reverb Gain and
     * Decay Time are independent properties: If you
     * adjust Decay Time without changing Late Reverb Gain, the total intensity (the averaged square of the
     * amplitude) of the late reverberation remains
     * constant.
     */
     ...
     * The Late Reverb Delay property defines the begin time, in seconds, of the late reverberation relative to the
     * time of the initial reflection (the first of
     * the early reflections).<br>
     * <br>
     * It ranges from 0 to 100 milliseconds. Reducing or increasing Late Reverb Delay is useful for simulating a
     * smaller or larger room.
     */
     ...
     * <br>
     * The direction of this vector controls the global direction of the reverb, while its magnitude controls how
     * focused the reverb are towards this direction.
     ...
     * <br>
     * A larger value of Echo Depth will make this effect more prominent. Echo Time controls the rate at which the
     * cyclic echo repeats itself along the
     * reverberation decay. For example, the default setting for Echo Time is 250 ms. causing the echo to occur 4
     * times per second. Therefore, if you were to
     * clap your hands in this type of environment, you will hear four repetitions of clap per second.<br>
     * <br>
     * Together with Reverb Diffusion, Echo Depth will control how long the echo effect will persist along the
     * reverberation decay. In a more diffuse
     * environment, echoes will wash out more quickly after the direct sound. In an environment that is less diffuse,
     * you will be able to hear a larger number
     * of repetitions of the echo, which will wash out later in the reverberation decay. If Diffusion is set to 0.0
     * and Echo Depth is set to 1.0, the echo will
     ...
     * <br>
     * This will be most noticeable applied to sources that have tonal color or pitch. You can use this to make some
     * trippy effects! Modulation Time controls
     ...
     * <br>
     * This will be most noticeable applied to sources that have tonal color or pitch. You can use this to make some
     * trippy effects! Modulation Depth controls
     * the amount of pitch change. Low values of Diffusion will contribute to reinforcing the perceived effect by
     * reducing the mixing of overlapping reflections
     ...
     * <br>
     * It applies to reflected sound only. You can use Air Absorption Gain HF to simulate sound transmission through
     * foggy air, dry air, smoky atmosphere, and
     * so on. The default value is 0.994 (-0.05 dB) per meter, which roughly corresponds to typical condition of
     * atmospheric humidity, temperature, and so on.
     * Lowering the value simulates a more absorbent medium (more humidity in the air, for example); raising the
     * value simulates a less absorbent medium (dry
     ...
     * high-frequency effects and the low-frequency effects
     ...
     * low frequency and high frequency properties
     * can be accurately controlled and will produce independent effects. In other words, the LF Reference value
     * should be less than 1/10 of the HF Reference
     * value.
     */
     ...
     * both reflections and reverberation)
     * according to source-listener distance.<br>
     * <br>
     * It’s defined the same way as OpenAL’s Rolloff Factor, but operates on reverb sound instead of direct-path
     * sound. Setting the Room Rolloff Factor value to
     * 1.0 specifies that the reflected sound will decay by 6 dB every time the distance doubles. Any value other
     * than 1.0 is equivalent to a scaling factor
     * applied to the quantity specified by ((Source listener distance) - (Reference Distance)). Reference Distance
     * is an OpenAL source parameter that specifies
     * the inner border for distance rolloff effects: if the source comes closer to the listener than the reference
     * distance, the direct-path sound isn’t
     * increased as the source comes closer to the listener, and neither is the reflected sound.<br>
     * <br>
     * The default value of Room Rolloff Factor is 0.0 because, by default, the Effects Extension reverb effect
     * naturally manages the reflected sound level
     * automatically for each sound source to simulate the natural rolloff of reflected sound vs. distance in typical
     * rooms. (Note that this isn’t the case if
     * the source property flag AL_AUXILIARY_SEND_FILTER_GAIN_AUTO is set to AL_FALSE) You can use Room Rolloff
     * Factor as an option to automatic control so you
     ...
     * from the setting of the property Air
     * Absorption HF.<br>
     * <br>
     * This limit applies regardless of the setting of the property Decay HF Ratio, and the limit doesn’t affect the
     * value of Decay HF Ratio. This limit, when
     * on, maintains a natural sounding reverberation decay by allowing you to increase the value of Decay Time
     * without the risk of getting an unnaturally long
     * decay time at high frequencies. If this flag is set to AL_FALSE, high-frequency decay time isn’t automatically
     * limited.
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.airAbsorptionGainHf, this.decayHfLimit, this.decayHfRatio, this.decayLfRatio,
                            this.decayTime, this.density, this.diffusion, this.echoDepth, this.echoTime, this.gain,
                            this.gainHf, this.gainLf, this.hfReference, this.lateReverbDelay, this.lateReverbGain,
                            this.lateReverbPan, this.lfReference, this.modulationDepth, this.modulationTime,
                            this.reflectionsDelay, this.reflectionsGain, this.reflectionsPan, this.roomRolloffFactor);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(this.airAbsorptionGainHf) == Float.floatToIntBits(other.airAbsorptionGainHf) &&
               this.decayHfLimit == other.decayHfLimit &&
               ...
               Objects.equals(this.lateReverbPan, other.lateReverbPan) &&
               Float.floatToIntBits(this.lfReference) == Float.floatToIntBits(other.lfReference) &&
    ...
    public String toString() {
        return "EaxReverb [density=" + this.density + ", diffusion=" + this.diffusion + ", gain=" + this.gain +
               ", gainHf=" + this.gainHf + ", gainLf=" + this.gainLf + ", decayTime=" + this.decayTime +
               ", decayHfRatio=" + this.decayHfRatio + ", decayLfRatio=" + this.decayLfRatio + ", reflectionsGain=" +
               this.reflectionsGain + ", reflectionsDelay=" + this.reflectionsDelay + ", reflectionsPan=" +
               this.reflectionsPan + ", lateReverbGain=" + this.lateReverbGain + ", lateReverbDelay=" +
               this.lateReverbDelay + ", lateReverbPan=" + this.lateReverbPan + ", echoTime=" + this.echoTime +
               ", echoDepth=" + this.echoDepth + ", modulationTime=" + this.modulationTime + ", modulationDepth=" +
               this.modulationDepth + ", airAbsorptionGainHf=" + this.airAbsorptionGainHf + ", hfReference=" +
               this.hfReference + ", lfReference=" + this.lfReference + ", roomRolloffFactor=" +
               this.roomRolloffFactor + ", decayHfLimit=" + this.decayHfLimit + "]";
    }
