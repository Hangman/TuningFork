...
/**
 * The flanger effect creates a “tearing” or “whooshing” sound (like a jet flying overhead). It works by sampling a
 * portion of the input signal, delaying it by
...
public class Flanger extends SoundEffectData {
     ...
     * Selects the shape of the LFO waveform that controls the amount of the delay of the sampled signal. Zero is a
     * sinusoid and one is a triangle.
     */
    public int waveform = 1;

    /**
     * Range: -180 - 180, Default: 0<br>
     * This changes the phase difference between the left and right LFO’s. At zero degrees the two LFOs are
     * synchronized.
     */
    public int phase = 0;
     ...
     * The number of times per second the LFO controlling the amount of delay repeats. Higher values increase the
     * pitch modulation.
     */
     ...
     * the phase of the feedback signal. Use this
     * parameter to create an “intense metallic” effect. At full magnitude, the identical sample will repeat
     * endlessly. At less than full magnitude, the sample
    ...
    public String toString() {
        return "Flanger [waveform=" + this.waveform + ", phase=" + this.phase + ", rate=" + this.rate + ", depth=" +
