...
public class WavExtensibleFormatTest extends ApplicationAdapter {
    ...
    public void create() {
        audio = Audio.init();
        sound = WaveLoader.load(Gdx.files.internal(WavExtensibleFormatTest.SOUND_PATH));
        final SoundSource bufferedSource = audio.obtainSource(sound);
        streamedSource = new StreamedSoundSource(Gdx.files.internal(WavExtensibleFormatTest.SOUND_PATH));
