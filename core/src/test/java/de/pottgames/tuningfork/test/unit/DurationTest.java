...
public class DurationTest {
    ...
    public void test32() {
        ...
        final String failMessageBuffer = assertionFailureMessage(
            file.name(),
            duration,
            bufferDuration,
            false
        );
        final String failMessageStream = assertionFailureMessage(
            file.name(),
            duration,
            streamDuration,
            true
        ...
        final boolean bufferDurationMatches = MathUtils.isEqual(
            duration,
            bufferDuration,
            tolerance
        );
        final boolean streamDurationMatches = MathUtils.isEqual(
            duration,
            streamDuration,
            tolerance
        );
        final boolean isStreamDuration = !MathUtils.isEqual(
            streamDuration,
            -1f
        );
        ...
        Assertions.assertTrue(
            streamDurationMatches || !isStreamDuration,
            failMessageStream
        );
    ...
    private void test(
        ...
        Assertions.assertTrue(
            MathUtils.isEqual(duration, bufferDuration, tolerance),
            failMessageBuffer
        );
        Assertions.assertTrue(
            MathUtils.isEqual(duration, streamDuration, tolerance),
            failMessageStream
        );
