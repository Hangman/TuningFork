...
public class WavInt24PcmTest extends ApplicationAdapter {
    ...
    public void create() {
        audio = Audio.init();
        sound = WaveLoader.load(Gdx.files.internal(WavInt24PcmTest.SOUND_PATH));
        final SoundSource bufferedSource = audio.obtainSource(sound);
        streamedSource = new StreamedSoundSource(Gdx.files.internal(WavInt24PcmTest.SOUND_PATH));
