...
public class MsAdpcmWavMonoTest extends ApplicationAdapter {
    ...
    public void create() {
        ...
        this.sound = WaveLoader.load(Gdx.files.internal(MsAdpcmWavMonoTest.SOUND_PATH));
        this.bufferedSource = this.audio.obtainSource(this.sound);
        this.streamedSource = new StreamedSoundSource(Gdx.files.internal(MsAdpcmWavMonoTest.SOUND_PATH));
