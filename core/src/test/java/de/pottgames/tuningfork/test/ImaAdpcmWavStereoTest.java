...
public class ImaAdpcmWavStereoTest extends ApplicationAdapter {
    ...
    public void create() {
        ...
        this.sound = WaveLoader.load(Gdx.files.internal(ImaAdpcmWavStereoTest.SOUND_PATH));
        final SoundSource bufferedSource = this.audio.obtainSource(this.sound);
        this.streamedSource = new StreamedSoundSource(Gdx.files.internal(ImaAdpcmWavStereoTest.SOUND_PATH));
