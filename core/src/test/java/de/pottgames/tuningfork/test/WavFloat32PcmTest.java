...
public class WavFloat32PcmTest extends ApplicationAdapter {
    private static final String SOUND_PATH = "32bit_float_numbers.wav";
    private Audio               audio;
    ...
    public void create() {
        ...
        this.sound = WaveLoader.load(Gdx.files.internal(WavFloat32PcmTest.SOUND_PATH));
        this.bufferedSource = this.audio.obtainSource(this.sound);
        this.streamedSource = new StreamedSoundSource(Gdx.files.internal(WavFloat32PcmTest.SOUND_PATH));
    ...
    public static void main(String[] args) {
        ...
        config.setTitle("WavFloat32PcmTest");
        config.setWindowedMode(1000, 800);
        config.useVsync(true);
        config.disableAudio(true);
        new Lwjgl3Application(new WavFloat32PcmTest(), config);
    }
}
