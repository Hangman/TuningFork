...
public class WavFloat32PcmTest extends ApplicationAdapter {
    ...
    public void create() {
        audio = Audio.init();
        sound = WaveLoader.load(Gdx.files.internal(WavFloat32PcmTest.SOUND_PATH));
        final SoundSource bufferedSource = audio.obtainSource(sound);
        streamedSource = new StreamedSoundSource(Gdx.files.internal(WavFloat32PcmTest.SOUND_PATH));
